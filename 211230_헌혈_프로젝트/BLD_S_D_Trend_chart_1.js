            ...
            var chart_1 = Highcharts.chart('BLD_Supply_Demand_1', {
                ...
                tooltip:{
                    formatter:function(){
                        ...
                        return '<p style="font-size:10px">'+this.x+'</p>'+'<br/>'+'<span style="color:' + this.point.color + '">\u25CF</span> '+this.series.name + " : "+"<b>"+Highcharts.numberFormat(this.point.y, 0) +"</b>"+"<br/>"+"헌혈 건수/명 : "+"<b>"+supply_day+"</b>"
                    }
                }
                },
            });

        ...
        $(document).ready(function (e) {
            ...
            nav.on('click', function (e) {
                ...
                switch (nav_cname) {
                    case "nav1":
                        $('html, body').animate({
                            scrollTop: blood_mark_y[0]+1
                        });
                        break;

                    case "nav2":
                        $('html, body').animate({
                            scrollTop:blood_mark_y[1]+1
                        });
                        break;

                    case "nav3":
                        $('html, body').animate({
                            scrollTop: blood_mark_y[2]+1
                        });
                        break;
                    case "nav4":
                        $('html, body').animate({
                            scrollTop: blood_mark_y[3]+1
                        });
                        break;
                    case "nav5":
                        $('html, body').animate({
                            scrollTop: blood_mark_y[4]+1
                        });
                        break;
                    case "nav6":
                        $('html, body').animate({
                            scrollTop: blood_mark_y[5]+1
                        });
                        break;
